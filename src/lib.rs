...
mod _ators {
    ...
    #[pymodule_export]
    use self::class::{
        AtorsBase, AtorsRef, MembersByNameMapping, PicklePolicy, atorsref,
        create_ators_specialized_alias, create_ators_specialized_subclass, create_ators_subclass,
        disable_notifications, drop_class_info, enable_notifications, freeze,
        get_ators_abstract_methods, get_ators_args, get_ators_frozen_flag,
    ...
    #[pymodule_export]
    use self::containers::{AtorsDefaultDict, AtorsDict, AtorsList, AtorsSet};
